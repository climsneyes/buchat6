...
BUSAN_FOOD_GUIDE_TEXTS = {
    ...
    "th": {
        ...
        "info": "คุณสามารถสอบถามเกี่ยวกับข้อมูลต่อไปนี้:",
        "items": [
            "🍜 ร้านก๋วยเตี๋ยวชื่อดังในปูซาน",
            "🦐 ร้านซาซิมิและอาหารทะเล",
            "🍖 ร้านซัมกยอบซัลและร้านเนื้อย่าง",
            "🍲 ร้านซุปและสตูว์",
            "🍰 ร้านกาแฟและของหวาน",
        ...
        "examples": [
            "• ร้านซุปหมูที่มีชื่อเสียงที่สุดในปูซานคือที่ไหน?",
            "• แนะนำร้านซาซิมิใกล้แฮอึนแด",
            "• มีร้านก๋วยเตี๋ยวราคาประหยัดใกล้สถานีปูซานไหม?",
            "• ร้านซัมกยอบซัลที่สะอาดในซอมยอน?",
            "• แนะนำร้านกาแฟริมหาดควางอันลี",
            "• อาหารที่น่าลองที่ตลาดกลางคืนปูซานคืออะไร?",
            "• เมนูยอดนิยมในซอยของกินนัมโพดงคืออะไร?",
            "• มีที่ไหนสำหรับ 4 คนในราคาต่ำกว่า 50,000 วอนบ้าง?"
        ],
        "input_hint": "ถามอะไรก็ได้เกี่ยวกับร้านอาหารปูซาน! 🍽️"
    },
    "fr": {
        "title": "Recherche de restaurants à Busan",
        "info": "Vous pouvez poser des questions sur :",
        "items": [
            "🍜 Restaurants de nouilles célèbres à Busan",
            "🦐 Spécialistes des sashimis et fruits de mer",
            "🍖 Restaurants de barbecue et de viande",
            "🍲 Plats de soupe et de ragoût",
            "🍰 Cafés et desserts",
        ...
        "examples": [
            "• Quel est le restaurant de soupe de porc le plus célèbre de Busan ?",
            "• Recommandez des restaurants de sashimi près de Haeundae",
            "• Y a-t-il des restaurants de nouilles bon marché près de la gare de Busan ?",
            "• Des restaurants de barbecue propres à Seomyeon ?",
            "• Recommandez des cafés près de la plage de Gwangalli",
            "• Quelle nourriture devrais-je essayer sur les marchés de nuit de Busan ?",
            "• Plats populaires dans l'allée de la nourriture de Nampo-dong ?",
            "• Des endroits pour 4 personnes pour moins de 50 000 wons ?"
        ],
        "input_hint": "Posez toutes vos questions sur les restaurants de Busan ! 🍽️"
    },
    "de": {
        ...
        "items": [
            ...
            "🦐 Sashimi- und Meeresfrüchtespezialisten",
            "🍖 BBQ- und Fleischrestaurants",
            "🍲 Suppen- und Eintopfgerichte",
            "🍰 Cafés und Desserts",
            "🍺 Bars und Straßenimbisse",
            "🥢 Regionale Restaurantempfehlungen",
            "💰 Restaurants nach Preisklasse"
        ],
        "example_title": "Beispielfragen:",
        "examples": [
            "• Was ist das berühmteste Schweinesuppenrestaurant in Busan?",
            "• Empfehlen Sie Sashimi-Restaurants in der Nähe von Haeundae",
            "• Gibt es günstige Nudelgeschäfte in der Nähe des Bahnhofs Busan?",
            "• Saubere BBQ-Restaurants in Seomyeon?",
            "• Empfehlen Sie Cafés in der Nähe des Gwangalli-Strandes",
            "• Welches Essen sollte ich auf den Nachtmärkten von Busan probieren?",
            "• Beliebte Gerichte in der Nampo-dong-Gasse?",
    ...
    "id": {
        ...
        "items": [
            ...
            "🍲 Hidangan sup dan rebusan",
            "🍰 Kafe dan makanan penutup",
            "🍺 Bar dan warung pinggir jalan",
            "🥢 Rekomendasi restoran regional",
            "💰 Restoran berdasarkan kisaran harga"
        ],
        "example_title": "Contoh pertanyaan:",
        "examples": [
            "• Restoran sup babi paling terkenal di Busan?",
            "• Rekomendasikan restoran sashimi di dekat Haeundae",
            "• Apakah ada toko mie murah di sekitar Stasiun Busan?",
            "• Restoran BBQ bersih di Seomyeon?",
            "• Rekomendasikan kafe di dekat Pantai Gwangalli",
            "• Makanan apa yang harus saya coba di pasar malam Busan?",
